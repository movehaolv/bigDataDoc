...
import com.atguigu.hotitems_analysis.utils.ReadAndWrite;
...
public class HotItems {
    public static void main(String[] args) throws Exception {
        ...
        // 2. 读取数据，创建DataStream
//        DataStream<String> inputStream = env.readTextFile("D:\\workLv\\learn\\proj\\hadoop-code\\UserBehaviorAnalysis" +
//                "\\HotItemsAnalysis\\src\\main\\resources\\UserBehavior.txt");
...
//        DataStream<String> inputStream = env.addSource(new FlinkKafkaConsumer<String>("hotitems", new SimpleStringSchema(), properties));
        ...
        windowAggStream.print("windowAggStream  ");
    ...
    public static class TopNHotItems extends KeyedProcessFunction<Tuple, ItemViewCount, String>{
        ...
        public void processElement(ItemViewCount value, Context ctx, Collector<String> out) throws Exception {
            ...
            System.out.println("注册事件触发时间 " + (value.getWindowEnd() + 1));
            ctx.timerService().registerEventTimeTimer( value.getWindowEnd() + 1 );
            System.out.println("当前key " + value.toString() + " 状态数量 " + Lists.newArrayList(itemViewCountListState.get()).size());
        }
        ...
        public void onTimer(long timestamp, OnTimerContext ctx, Collector<String> out) throws Exception {
            ...
            resultBuilder.append("===============================\n\n");
            ReadAndWrite.writeFile(resultBuilder.toString());
            // 控制输出频率
//            Thread.sleep(1000L);
